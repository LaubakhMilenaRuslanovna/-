...
static const qt_meta_stringdata_creditCAlc_t qt_meta_stringdata_creditCAlc = {
    ...
    "creditCAlc\0firstWindow\0\0on_pushButton_clicked\0"
...
void creditCAlc::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id,
                                    void **_a) {
  if (_c == QMetaObject::InvokeMetaMethod) {
    ...
    int *result = reinterpret_cast<int *>(_a[0]);
    {
      ...
      if (*reinterpret_cast<_t *>(_a[1]) ==
          static_cast<_t>(&creditCAlc::firstWindow)) {
        *result = 0;
        return;
      }
    }
...
const QMetaObject creditCAlc::staticMetaObject = {
    {QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
     qt_meta_stringdata_creditCAlc.offsetsAndSize, qt_meta_data_creditCAlc,
     qt_static_metacall, nullptr,
     qt_incomplete_metaTypeArray<
         qt_meta_stringdata_creditCAlc_t,
